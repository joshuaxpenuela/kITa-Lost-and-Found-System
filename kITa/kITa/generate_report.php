...
if (isset($_POST['generate_report'])) {
    ...
    <p>Total Reports: ' . $total_items . '<br>
    Unclaimed Items: ' . $stats['unclaimed_items'] . ' (' . number_format($unclaimed_percentage, 1) . '%)<br>
    Claimed Items: ' . $stats['claimed_items'] . ' (' . number_format($claimed_percentage, 1) . '%)</p>';
    ...
    $dompdf->stream('weekly_report_' . date('Y-m-d') . '.pdf', ['Attachment' => false]);
    exit();
}
?>
                ...
                <form method="POST" class="mt-4">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>&nbsp;</label>
                                <button type="submit" name="generate_report" class="btn btn-primary form-control">
