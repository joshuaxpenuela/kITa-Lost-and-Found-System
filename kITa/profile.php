...
// Fetch admin details
$stmt = $conn->prepare("SELECT id, username, fname, lname, password, profile_image FROM admins WHERE username = ?");
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $new_firstname = htmlspecialchars(strtoupper(trim($_POST['fname'])));
    $new_lastname = htmlspecialchars(strtoupper(trim($_POST['lname'])));
    ...
    $sql = "UPDATE admins SET username = ?, fname = ?, lname = ?, password = ?";
    $types = "ssss";
    $params = array($new_username, $new_firstname, $new_lastname, $new_password);
